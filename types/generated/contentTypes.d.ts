...
export interface ApiBookedUserBookedUser extends Struct.CollectionTypeSchema {
  collectionName: 'booked_users';
  info: {
    displayName: 'bookedUser';
    pluralName: 'booked-users';
    singularName: 'booked-user';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    DOB: Schema.Attribute.Date & Schema.Attribute.Required;
    DriverLicenseNo: Schema.Attribute.String & Schema.Attribute.Required;
    email: Schema.Attribute.Email &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
    ...
    EmergencyContactName: Schema.Attribute.String & Schema.Attribute.Required;
    EmergencyContactNo: Schema.Attribute.BigInteger & Schema.Attribute.Required;
    EmiratesID: Schema.Attribute.BigInteger &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          max: '15';
    ...
    FirstAidKit: Schema.Attribute.Boolean & Schema.Attribute.Required;
    Flag: Schema.Attribute.Boolean & Schema.Attribute.Required;
    LicenseExpiry: Schema.Attribute.Date & Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'plugin::users-permissions.user'
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::booked-user.booked-user': ApiBookedUserBookedUser;
